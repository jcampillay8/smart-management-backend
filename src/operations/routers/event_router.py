...
async def create_event(
    ...
    return await EventService.create_event(db, event_data, current_user.id)
...
async def execute_event(
    ...
    """
    return await EventService.execute_event(db, event_id, current_user.id)
...
async def cancel_event(
    ...
    return await EventService.cancel_event(db, event_id)