...
from src.inventory.routers.merma_router import router as merma_router # <--- Agregar import
...
inventory_router.include_router(merma_router, prefix="/mermas") # <--- Registrar router